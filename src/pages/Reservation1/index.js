    ...
    <Column className="bg-lime_50 items-center justify-start ml-[auto] mr-[auto] w-[100%]">
      ...
      <Column className="3xl:mt-[192px] font-nunito justify-start lg:mt-[124px] mt-[160px] self-stretch w-[100%] xl:mt-[142px]">
        ...
        <Column className="3xl:mt-[9px] font-nunito items-center lg:mt-[6px] mt-[8px] self-stretch w-[100%] xl:mt-[7px]">
          ...
          ></TextArea>
          <Button className="2xl:px-[23px] 3xl:mt-[48px] 3xl:px-[28px] 3xl:py-[20px] 3xl:text-fs16 bg-deep_orange_700 border-bw font-normal lg:mt-[31px] lg:px-[18px] lg:py-[13px] lg:text-fs10 mt-[40px] mx-[auto] px-[23.5px] py-[17px] text-center text-fs14 text-white_A700 w-[11%] xl:mt-[35px] xl:px-[20px] xl:py-[15px] xl:text-fs12">{`Make Reservation`}</Button>
        </Column>
      </Column>
