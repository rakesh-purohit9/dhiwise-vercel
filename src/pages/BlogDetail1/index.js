    ...
    <Column className="bg-white_A700 items-center justify-start ml-[auto] mr-[auto] w-[100%]">
      <Column className="justify-start self-stretch w-[100%]">
        <Column className="font-playfairdisplay items-center self-stretch w-[100%]">
          ...
          ></Input>
          <Input
            className="2xl:mt-[30px] 2xl:pb-[37px] 2xl:pt-[2px] 3xl:mt-[36px] 3xl:pb-[44px] 3xl:pt-[2px] 3xl:text-fs28 bg-transparent border-0 border-b-[1px] border-bluegray_101 border-solid font-manrope font-medium lg:mt-[23px] lg:pb-[28px] lg:pt-[1px] lg:text-fs18 mt-[30.01001px] mx-[auto] pb-[37.06px] pl-[0] placeholder:bg-transparent placeholder:text-gray_600 pt-[2.0600004px] text-fs24 text-gray_600 text-left w-[51%] xl:mt-[26px] xl:pb-[32px] xl:pt-[1px] xl:text-fs21"
            name="Group133"
            placeholder={`Your Email*`}
          ></Input>
          <div className="2xl:mt-[30px] 3xl:mt-[36px] 3xl:mx-[12px] bg-transparent border-0 lg:mt-[23px] lg:mx-[7px] mt-[30.01001px] mx-[10px] w-[51%] xl:mt-[26px] xl:mx-[8px] input-wrap">
            <Image
              src="img_griphorizontal_3.svg"
